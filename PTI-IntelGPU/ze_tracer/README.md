# Level Zero Tracer
## Source Code
**This repo is an archive for ze_tracer, you can refer [ze_tracer](https://github.com/intel/pti-gpu/tree/master/tools/ze_tracer) to get source code or use the binary of this repo directly.**

## Quick BKM in Linux
```
cp ze_tracer libzet_tracer.so <your dir>
./ze_tracer [options] <application> <args>
```
## Overview
