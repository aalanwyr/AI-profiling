...
## Source Code
**This repo is an archive for onetracer, you can refer  [onetrace](https://github.com/intel/pti-gpu/tree/master/tools/ze_tracer) to get source code or use the binary of this repo directly.**

## Quick BKM in Linux
```
cp onetrace libonetrace_tool.so <your dir>
./onetrace [options] <application> <args>
```
## Overview
